...
const WORKFLOW_JOB_TEMPLATES_ENDPOINT = API_ENDPOINT + "workflow_job_templates/"
const WORKFLOW_JOB_TEMPLATE_NODES_ENDPOINT = API_ENDPOINT + "workflow_job_template_nodes/"
